...
export default function ListDesktop({ projectArray }: ListDesktopProps) {
  ...
  return (
    <List className="laptop:flex hidden pb-[60px]">
      ...
      {hoveredImage && (
        <Link href={`/${hoveredLink}`}>
          <UIImageSanity
            ...
            className="bottom-5 fixed right-5 z-0  desktop:max-h-[450px] desktop:max-w-[350px] laptop:max-h-[350px] laptop:max-w-[25 0px]"
          />
        </Link>
      )}
    </List>
